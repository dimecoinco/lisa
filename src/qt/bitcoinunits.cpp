...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LISA");
    case mBTC: return QString("mLISA");
    case uBTC: return QString::fromUtf8("μLISA");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LisaCoins"));
    case mBTC: return QString(QObject::tr("Milli-LisaCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LisaCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
